...
templ1.setTemplate(`
        <template _id="todolistpage_1"></template>
    `);
const templ2 = new Aventus.Template(this);
templ2.setTemplate(` 
            <td-todo-display _id="todolistpage_2"></td-todo-display>
        `);
templ2.setActions({
  "content": {
    "todolistpage_2°todo_id": {
      "fct": (c) => `${c.print(c.comp.__76dd530e84276b51e9aa2274f7490716method3(c.data.todo))}`,
      "once": true
    }
  },
  "contextEdits": [
    {
      "fct": (c) => c.comp.__76dd530e84276b51e9aa2274f7490716method2(c.data.i)
    }
  ]
});
templ1.addLoop({
                    anchorId: 'todolistpage_1',
                    template: templ2,
...
this.__getStatic().__template.addIf({
                    ...
                    parts: [{once: true,
                    condition: (c) => c.comp.__76dd530e84276b51e9aa2274f7490716method0(),
                    template: templ0
                },{once: true,
                    condition: (c) => true,
                    template: templ1
    ...
    __76dd530e84276b51e9aa2274f7490716method3(todo) {
        return todo.id;
    }
    __76dd530e84276b51e9aa2274f7490716method0() {
        return this.todos.length == 0;
    }
    __76dd530e84276b51e9aa2274f7490716method2(i) {
