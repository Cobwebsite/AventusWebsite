...
this.__getStatic().__template.setActions({
  "content": {
    "todocreatepage_1°@HTML": {
      "fct": (c) => `${c.print(c.comp.__41f8074af84a74ccb1c91af704ef2d04method2())}`,
      "once": true
    }
  },
  "bindings": [
    {
      ...
      "inject": (c) => c.comp.__41f8074af84a74ccb1c91af704ef2d04method0(),
      "extract": (c, v) => c.comp.__41f8074af84a74ccb1c91af704ef2d04method1(v),
      "once": true,
      "isCallback": true
    }
  ]
    ...
    __41f8074af84a74ccb1c91af704ef2d04method2() {
        return this.todo.name;
    }
    __41f8074af84a74ccb1c91af704ef2d04method0() {
        return this.todo.name;
    }
    __41f8074af84a74ccb1c91af704ef2d04method1(v) {
        if (this.todo) {
            this.todo.name = v;
        }
    }
