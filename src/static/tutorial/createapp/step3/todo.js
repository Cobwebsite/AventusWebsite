...
let _n;
const TodoCreatePage = class TodoCreatePage extends Aventus.Navigation.Page {
    static __style = ``;
    __getStatic() {
...
const TodoListPage = class TodoListPage extends Aventus.Navigation.Page {
    static __style = `:host .page-title{height:50px;width:100%;display:flex;align-items:center;justify-content:center;font-size:30px;margin:30px 0}`;
    __getStatic() {
        return TodoListPage;
    }
    __getStyle() {
...
const MainApp = class MainApp extends Aventus.Navigation.Router {
    static __style = `:host{display:flex;flex-direction:row;height:100%;overflow:hidden;width:100%}:host .nav{background-color:var(--color-surface-mixed-300);height:100%;padding-top:30px;width:200px}:host .content{width:calc(100% - 200px);height:100%}`;
    __getStatic() {
        return MainApp;
    }
    __getStyle() {
